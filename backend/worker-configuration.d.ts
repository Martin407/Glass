/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 35fb2952ed064dc9f90a47d1e214919c)
// Runtime types generated with workerd@1.20260409.1 2026-04-11 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RealtimeStateObject";
	}
	interface Env {
		DB: D1Database;
		OKTA_DOMAIN: string;
		OKTA_CLIENT_ID: string;
		REALTIME_STATE: DurableObjectNamespace<import("./src/index").RealtimeStateObject>;
	}
}
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
     ...
     *    - color: rgb or hex representation of the color you wish to trim or rgba CSS4 modern syntax
