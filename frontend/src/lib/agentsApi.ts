...
export const agentsApi = {
  // Agents
  createAgent: (data: Record<string, unknown>) => fetchApi('/agents', { method: 'POST', body: JSON.stringify(data) }),
  listAgents: () => fetchApi('/agents'),
  getAgent: (id: string) => fetchApi(`/agents/${id}`),
  updateAgent: (id: string, data: Record<string, unknown>) => fetchApi(`/agents/${id}`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  updateSession: (id: string, data: Record<string, unknown>) => fetchApi(`/sessions/${id}`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  sendSessionEvent: (sessionId: string, data: Record<string, unknown>) => fetchApi(`/sessions/${sessionId}/events`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  // Session Resources
  addSessionResource: (sessionId: string, data: Record<string, unknown>) => fetchApi(`/sessions/${sessionId}/resources`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  updateSessionResource: (sessionId: string, resourceId: string, data: Record<string, unknown>) => fetchApi(`/sessions/${sessionId}/resources/${resourceId}`, { method: 'POST', body: JSON.stringify(data) }),
  deleteSessionResource: (sessionId: string, resourceId: string) => fetchApi(`/sessions/${sessionId}/resources/${resourceId}`, { method: 'DELETE' }),

  // Environments
  createEnvironment: (data: Record<string, unknown>) => fetchApi('/environments', { method: 'POST', body: JSON.stringify(data) }),
  listEnvironments: () => fetchApi('/environments'),
  getEnvironment: (id: string) => fetchApi(`/environments/${id}`),
  updateEnvironment: (id: string, data: Record<string, unknown>) => fetchApi(`/environments/${id}`, { method: 'POST', body: JSON.stringify(data) }),
